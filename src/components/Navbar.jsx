...
const links = [
  ...
  { label: 'Equipamentos', href: '#locacao' },
    ...
    >
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 68 }}>
        ...
        <div className="nav-links" style={{ display: 'flex', alignItems: 'center', gap: 32 }}>
          {links.map(link => (
            <a key={link.href} href={link.href} style={{ fontSize: 13.5, fontWeight: 500, color: 'var(--muted)', textDecoration: 'none', fontFamily: 'var(--font-body)', paddingBottom: 2, borderBottom: '3px solid transparent', transition: 'color 0.2s, border-color 0.2s' }}
